...
namespace UWin32
{
	...
	public class Comm
	{
		...
		bool Open(CommBaseSettings cbs)
		{
			IntPtr hPort = Win32Com.CreateFile(cbs.port,
											   Win32Com.GENERIC_READ | Win32Com.GenericWrite,
											   0,
											   IntPtr.Zero,
											   Win32Com.OPEN_EXISTING,
											   0,
	...
	public abstract class CommBase : IDisposable
	{
		...
		private void ReceiveThread() {
			...
			try
			{
				while(true) 
				{
					if (!Win32Com.SetCommMask(hPort, Win32Com.EV_RXCHAR | Win32Com.EV_TXEMPTY | Win32Com.EV_ERR))
...
//					if ((eventMask & Win32Com.EV_RING) != 0) i |= Win32Com.MS_RING_ON;
	...
	public class fs
	{
		...
		public static extern Int32 CreateFile(
...
//		[DllImport("kernel32.dll", EntryPoint="GetCommState", SetLastError=true, CharSet=CharSet.Unicode)] 
//		public static extern Int32 GetCommState(
//			Int32 hFile,
//			IntPtr );
